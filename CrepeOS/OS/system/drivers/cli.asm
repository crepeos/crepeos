...
; =====================================================================
    ...
    help_text2      db 'DIR- Shows a basic menu of all files in the directory.', 13, 10, 0
    help_text3      db 'LS- Shows a detailed tree of all files in the directory.', 13, 10, 0 
    help_text4      db 'COPY- Copies a specified file.', 13, 10, 0
    help_text5      db 'REN- Renames specified file.', 13, 10, 0
    help_text6      db 'DEL- Deletes specified file.', 13, 10, 0
    help_text7      db 'CAT- See the CrepeOS User Manual for help with CAT.', 13, 10, 0
    help_text8      db 'SIZE- Displays the size of the specified file.', 13, 10, 0
    help_text9      db 'CLEAR- Clears the screen.', 13, 10, 0
    help_text10     db 'HELP- Displays this help menu.', 13, 10, 0
    help_text11     db 'TIME or DATE- Displays the Time or Date on-screen.', 13, 10, 0
    help_text12     db 'VER- Displays the version of CrepeOS.', 13, 10, 0
    help_text13     db 'EXIT- Exits the prompt and brings you back to the select menu.', 13, 10, 0
	...
	finished_msg		db '>>> Process completed. Press any key to continue...', 0

	version_msg		db 'Welcome to CrepeOS ', CREPEOS_VER, '   ', 13, 10, 0

	logo_line1 db '  ____                      ___  ____ ', 13, 10, 0
	logo_line2 db ' / ___|_ __ ___ _ __   ___ / _ \/ ___|', 13, 10, 0
