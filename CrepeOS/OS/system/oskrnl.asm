	...
	%DEFINE CREPEOS_VER '0.2 Alpha'	; OS version number
...
os_main:
	...
	mov es, ax			; segments ever again, as CrepeOS and its programs
...
app_selector:
	...
	mov si, ax			; Did the user try to run 'OSKRNL.BIN'?
...
not_bas_extension:
	...
	kern_file_name		db 'OSKRNL.BIN', 0
...
; ------------------------------------------------------------------
; DRIVERS/FEATURES -- Code to pull into the kernel


	%INCLUDE "drivers/cli.asm"
 	%INCLUDE "drivers/disk.asm"
	%INCLUDE "drivers/keyboard.asm"
	%INCLUDE "drivers/math.asm"
	%INCLUDE "drivers/misc.asm"
