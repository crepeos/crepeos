...
echo "Welcome to the CrepeOS 10.0 builder."
...
mkisofs -quiet -V 'CrepeOS10' -input-charset iso8859-1 -o image/crepeos.iso -b crepeos.flp image/ || exit
sleep 0.25

echo 'Starting CrepeOS now via QEMU...'
cd image
qemu-system-i386 -fda crepeos.flp
